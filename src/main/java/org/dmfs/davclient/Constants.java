...
public final class Constants
{
     ...
     */
    public final static MediaType CONTENT_TYPE_APPLICATION_XML = new StructuredMediaType("application", "xml", "utf-8");

    /**
     * The alternate content type for DAV XML responses and requests.
     */
    public final static MediaType CONTENT_TYPE_TEXT_XML = new StructuredMediaType("text", "xml", "utf-8");
